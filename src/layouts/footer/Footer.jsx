        ...
        <Row className="w-100">
          ...
          <Col className="d-flex justify-content-end">
            <Nav className="list-unstyled d-flex">
              <Nav.Item>
                <Nav.Link href="https://www.instagram.com/iesmiguelherreroligasolidaria?igsh=N3czYW1YXdsZ3Nv" title='Ir a Instagram.' target="_blank" rel="noopener noreferrer" className="text-body-secondary ms-3">
